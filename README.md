...
<div align="center">
  ...
  <a href="https://github.com/tugcemankal">
    <img src="https://readme-typing-svg.demolab.com?font=Quicksand&weight=600&size=22&duration=3000&pause=1000&color=A78BFA&center=true&vCenter=true&width=500&lines=Computer+Engineer+%F0%9F%92%BB;Network+Systems+%26+AI+%F0%9F%A4%96;Full-Stack+Developer+%E2%9C%A8;Always+Learning...%F0%9F%93%9A" alt="Typing SVG" />
  </a>
</div>
...
### 🌌 Welcome to My World!
As a **Computer Engineer**, I use coding not just to solve problems, but also to create digital **art**. I love touching every aspect of software, from low-level network algorithms to AI-supported IoT systems and modern web applications! 💜✨

<img align="right" src="http://store.donanimhaber.com/b4/74/dd/b474ddba5595ba07c8741c5c6c77090d.gif" width="200" />

- 🔭 **What I'm doing now:** Developing network communication simulations, Blockchain, IoT, and Full-Stack web platforms.
- 🌱 **Interests:** Network Architectures, Computer Vision (VLM), Smart Contracts (Solidity), and UI/UX design.
- 👯 **What I'm looking for:** Open-source projects and teammates to brainstorm and create amazing ideas with!
- 🎨 **Hidden Talent:** Transforming complex mathematical theories (Queueing Theory, CRC, OSPF, etc.) and machine learning models into perfectly working cute systems! 🌟
- 💌 **Contact me:** <a href="mailto:tugce.mankal18@gmail.com">tugce.mankal18@gmail.com</a>
...
### 🛠️ Developer Toolbox (Technologies I Use)
...
**[💖 TYT Tracking Platform (PWA Web)](https://github.com/tugcemankal/tyt-takip)**  
An excellent study tracking system specially designed for students and administrators, instantly synchronized with **Firebase**. It includes a dark mode and advanced scheduling algorithms.

**[🚗 Smart Road Monitoring System (IoT & ML)](https://github.com/tugcemankal/akilli-yol-izleme-sistemi)**  
An early warning project developed for the D400 highway, including an IoT sensor-based WSN simulation and a real-time **Machine Learning (J48/Naive Bayes)** classification system. (Java)

**[🔗 Blockchain-Based Secure Voting System](https://github.com/tugcemankal/blokchain-tabanli-guvenli-oylama-sistemi)**  
A manipulation-proof, transparent, and distributed voting infrastructure using **Solidity** and smart contracts. Vote security is ensured with cryptographic algorithms.
...
An artificial intelligence / computer vision-supported medical imaging project on the classification of medical images. (Python)

**[🌐 Network Architecture and Simulation Projects](https://github.com/tugcemankal)**  
- **IPv4 Router:** IPv4 packet parsing and routing algorithm with Java.
- **Smart Gateway & Buffer Analysis:** Analysis of asynchronous IoT telemetry packets with Poisson Distribution and Queueing Theory. (Python)
- **HDLC Data Link Simulation:** CRC error checking and bit stuffing operations. (Python)
- **Physical Layer Signal Coding:** Analysis of NRZ-L and Manchester line coding techniques.
- **TCP/UDP Communication:** Multi-agent communication and file transfer with Java Socket.
- **Comprehensive Network Topology:** Cisco Packet Tracer simulation integrated with IoT, featuring dynamic routing (OSPF) and DHCP configurations.
...
<div align="center">
  <br/>
  <img src="https://komarev.com/ghpvc/?username=tugcemankal&color=7c3aed&style=flat-square&label=Awesome+People+Who+Visited+My+Profile" alt="Visitor Counter" />
</div>
